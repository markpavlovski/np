      ...
      ? (function e(t, n) {
          ...
          for (i = 0; i < t.length; i++)
            M((o = t[i])) ||
              ...
              Array.isArray(o)
                ? 0 < o.length &&
                  (at((o = e(o, (n || "") + "_" + i))[0]) && at(s) && ((r[a] = pe(s.text + o[0].text)), o.shift()), r.push.apply(r, o))
                : T(o)
                ? at(s)
                  ? (r[a] = pe(s.text + o))
                  : "" !== o && r.push(pe(o))
  ...
  function Er(e, t) {
    var n = (function(e) {
      if (((e = e.trim()), (fr = e.length), e.indexOf("[") < 0 || e.lastIndexOf("]") < fr - 1))
        return -1 < (vr = e.lastIndexOf(".")) ? { exp: e.slice(0, vr), key: '"' + e.slice(vr + 1) + '"' } : { exp: e, key: null };
      (pr = e), (vr = hr = mr = 0);
          ...
          M(t.text)
            ? D(s) && D(c)
              ? s !== c &&
                (function(e, t, n, r, i) {
                  for (
                    var o, a, s, c = 0, l = 0, u = t.length - 1, f = t[0], p = t[u], d = n.length - 1, v = n[0], h = n[d], m = !i;
                    c <= u && l <= d;
      ...
      (function(i, d) {
        ...
        function A(e, t, n) {
          ...
          if (0 <= r) {
            ...
            "br" === i ? d.start && d.start(e, [], !0, t, n) : "p" === i && (d.start && d.start(e, [], !1, t, n), d.end && d.end(e, t, n));
        }
        A();
      })(e, {
        warn: wo,
        ...
        start: function(e, t, n) {
          ...
          var i,
            ...
            l = Ro(e, t, v);
          r && (l.ns = r),
            ("style" !== (i = l).tag && ("script" !== i.tag || (i.attrsMap.type && "text/javascript" !== i.attrsMap.type))) ||
              Y() ||
              (l.forbidden = !0);
    ...
    Qi,
    {
      preTransformNode: function(e, t) {
        if ("input" === e.tag) {
          ...
          if (!r["v-model"]) return;
          if (
            ((r[":type"] || r["v-bind:type"]) && (n = Or(e, "type")), r.type || n || !r["v-bind"] || (n = "(" + r["v-bind"] + ").type"), n)
          ) {
            var i = Sr(e, "v-if", !0),
              o = i ? "&&(" + i + ")" : "",
          ...
          if ("select" === $)
            ...
            (c = e),
              ...
              Cr(
                c,
                "checked",
                "Array.isArray(" + l + ")?_i(" + l + "," + p + ")>-1" + ("true" === d ? ":(" + l + ")" : ":_q(" + l + "," + d + ")")
              ),
              Ar(
                c,
                "change",
    ...
    return t.for && !t.forProcessed
      ...
      : "{key:" +
          ...
          ("function(" +
            String(t.slotScope) +
            "){return " +
            ("template" === t.tag ? (t.if ? t.if + "?" + (_a(t, n) || "undefined") + ":undefined" : _a(t, n) || "undefined") : da(t, n)) +
            "}") +
          "}";
    var r, i, o, a, s, c, l;
  }
